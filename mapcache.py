...
def main(argv):
    ...
    mapcache += u"&lt;mapcache&gt;\n";
    mapcache += u"  &lt;metadata&gt;\n";
    mapcache += u"    &lt;title&gt;Mapcache service for url: ' + urlRequestCapa + '&lt;/title&gt;\n";
    mapcache += u"    &lt;abstract&gt;Render map services for url: ' + urlRequestCapa + '&lt;/abstract&gt;\n";
    mapcache += u"  &lt;/metadata&gt;\n\n";

    # Cache: Disk
    mapcache += u"  &lt;cache name=\"disk\" type=\"disk\"&gt;\n";
    mapcache += u"    &lt;base&gt;/tmp/' + project + '&lt;/base&gt;\n";
    ...
    mapcache += u"    &lt;base&gt;/tmp' + project + '&lt;/base&gt;\n";
    mapcache += u"    &lt;template&gt;/tmp/' + project + '/template/{tileset}#{grid}#{dim}/{z}/{x}/{y}.{ext}&lt;/template&gt;\n";
    mapcache += u"  &lt;/cache&gt;\n\n";

    # Cache: sqlite
    mapcache += u"  &lt;cache name=\"sqlite\" type=\"sqlite3\"&gt;\n";
    mapcache += u"    &lt;dbfile&gt;/tmp/' + project + '/sqlitetiles.db&lt;/dbfile&gt;\n";
    mapcache += u"    &lt;pragma name=\"key\"&gt;value&lt;/pragma&gt;\n";
    mapcache += u"  &lt;/cache&gt;\n\n";

    # Cache: MbTiles
    mapcache += u"  &lt;cache name=\"mbtiles\" type=\"mbtiles\"&gt;\n";
    mapcache += u"    &lt;dbfile&gt;/tmp/' + project + '/' + project + '.mbtiles&lt;/dbfile&gt;\n";
    mapcache += u"  &lt;/cache&gt;\n\n";
    ...
    for layername in wms.contents:
        ...
        for sname in arrayTab:
            ...
            source = u"SOURCE_" + layer.name + "_" + sname;

            mapcache += u"  &lt;!-- Source for layer: " + layer.name + u", style: " + sname + u" --&gt;\n";
            mapcache += u"  &lt;source name=\"" + source + u"\" type=\"wms\"&gt;\n";
            mapcache += u"    &lt;http&gt;\n";
            mapcache += u"      &lt;url&gt;' + urlRequestCapa + '&lt;/url&gt;\n";
            mapcache += u"    &lt;/http&gt;\n";
            mapcache += u"    &lt;getmap&gt;\n";
            mapcache += u"      &lt;params&gt;\n";
            mapcache += u"        &lt;FORMAT&gt;image/png&lt;/FORMAT&gt;\n";
            mapcache += u"        &lt;LAYERS&gt;' + layer.name + '&lt;/LAYERS&gt;\n";
            mapcache += u"        &lt;STYLES&gt;' + sname + '&lt;/STYLES&gt;\n";
            mapcache += u"      &lt;/params&gt;\n";
            mapcache += u"    &lt;/getmap&gt;\n";
            mapcache += u"  &lt;/source&gt;\n\n";

            mapcache += u"  &lt;!-- Tileset for layer: ' + layer.name + ', style: ' + sname + ' --&gt;\n";
            mapcache += u"  &lt;tileset name=\"" + tileset + u"\"&gt;\n";
            mapcache += u"    &lt;source&gt;' + source + '&lt;/source&gt;\n";
    ...
    for lname in wms.contents:
        ...
        for sname in arrayTab:
            ...
            mapcache += u"      &lt;param name=\"LAYERS\" type=\"values\"&gt;' + layer.name + '&lt;/param&gt;\n";
            mapcache += u"      &lt;param name=\"STYLES\" type=\"values\"&gt;' + sname + '&lt;/param&gt;\n";
            mapcache += u"      &lt;http&gt;\n";
            mapcache += u"        &lt;url&gt;' + urlRequestCapa + concat + 'LAYERS=' + tileset + '&lt;/url&gt;\n";
            mapcache += u"      &lt;/http&gt;\n";
    ...
    mapcache += u"  &lt;lock_dir&gt;/tmp/' + project + '&lt;/lock_dir&gt;\n";
